...
class ContactController extends Controller
{
    ...
    public function send_email(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                'visitor_name.required' => ERROR_MESSAGE_NAME_EMPTY,
                'visitor_email.required' => ERROR_MESSAGE_EMAIL_EMPTY,
                'visitor_email.email' => ERROR_MESSAGE_EMAIL_VALID,
                'visitor_message.required' => ERROR_MESSAGE_MESSAGE_EMPTY
            ]
        );
        ...
        return redirect()->back()->with('success', SUCCESS_MESSAGE_CONTACT_FORM);
    }
}
